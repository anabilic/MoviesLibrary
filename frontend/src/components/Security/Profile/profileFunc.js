...
const Profile = (props) => {
    ...
    useEffect(() => {
        ...
        // axios.get("/user?id="+user.id).then((data)=>{
            ...
            <div>
                <div className="row" style={{backgroundColor:'#1c1c1c', fontFamily: 'Helvetica'}}>
                    ...
                    <div className="col-md-4">
                        ...
                        <img src={`data:image/jpeg;base64,${user.file}`}  alt="" className="topPhoto rounded"/>
                        }
                    ...
                    <div className="col-md-4">
                        ...
                        <br/>
                        <span>
                                <Link to={"/editUser/"+user.id} style={{color:'white', marginLeft:'15px',fontSize: '18px',fontFamily: 'Helvetica'}}>
                            <i className="fa fa-edit">
                            <span className="font-italic">Edit my profile</span>
                            </i>
                            </Link>
